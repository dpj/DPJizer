...
public class DPJPartitionInt<region R> {
	...
	public DPJPartitionInt(DPJArrayInt<R> A, final int idx, boolean open) 
	//	writes this:[?]
	{
		this.A = A;
		this.length = 2;
	...
	private DPJPartitionInt(DPJArrayInt<R> A, int stride, double strided) 
	//	pure 
	{
		this.A = A;
		this.stride = stride;
	...
	public static<region R>DPJPartitionInt<R> stridedPartition(DPJArrayInt<R> A, int stride) 
	//	pure 
	{
	 ...
	 */
	public <region RA>DPJPartitionInt(DPJArrayInt<R> A, int[]<RA> idxs) 
