...
public class RatePath<region P> extends PathId<P> {
	 ...
	 *        fractions of a year.
	 */
	public RatePath(double[]<P> pathValue, String name, int startDate, int endDate, double dTime) 
	//	reads Root writes P 
	{
		set_name(name);
	 ...
	 */
	public RatePath(MonteCarloPath<P> mc) 
	//	reads Root writes P 
	throws DemoException {
		//
	 ...
	 */
	public void inc_pathValue(double[]<P> operandPath)
	//	reads P writes P 
	{
	 ...
	 */
	public void set_pathValue(double[]<P> pathValue)
	//	writes P
	{
		this.pathValue = pathValue;
	}
	...
	public ReturnPath<P> getReturnCompounded() 
	//	reads Root writes P 
	throws DemoException {
