 ...
 * 
 */
public class TestConstraintSolver23 extends DPJInferencerTestCase {
	@Test
	public void testMontecarlo() throws Throwable {
		// fail(DEPRECATED_SYNTAX);
		compareSolvedConstraints("Montecarlo", new String[] { "AppDemo", "CallAppDemo", "DemoException", "JGFInstrumentor", "JGFMonteCarloBench",
